...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-dark-950 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-krato/[0.06] blur-[100px] animate-pulseGlow" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-blue-500/[0.04] blur-[100px] animate-pulseGlow" />

      <div className="relative z-10 w-full max-w-md px-6">
        {/* Split screen: left brand, right form on larger screens */}
        <motion.div
        ...
        >
          ...
          <p className="text-zinc-400 text-sm mb-8">Log in to your account to continue.</p>
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            ...
            <Link href="/signup" className="text-krato font-medium hover:text-krato-light transition">
              Sign Up
            </Link>
          </p>
        </motion.div>
